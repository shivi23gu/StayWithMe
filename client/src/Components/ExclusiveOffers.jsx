    ...
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-32">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4">
        ...
        <button
          ...
          className="group flex items-center gap-2 px-6 py-2 border border-gray-300 rounded hover:bg-gray-50 transition-all shrink-0"
        >
          View All Offers
          <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 w-full">
        {exclusiveOffers.map((item) => (
          <div
            key={item._id}
            className="group relative flex flex-col justify-end gap-4 p-6 rounded-xl text-white bg-no-repeat bg-cover bg-center h-72 md:h-80 cursor-pointer"
