...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // FIXED: standard dashboard endpoint map kiya
      ...
      if (data && data.success) {
        ...
        console.log("Dashboard response success false:", data?.message);
      }
    } catch (error) {
      console.error("Dashboard Fetch Error:", error);
    } finally {
      // FIXED: Har haal mein loading false hogi taaki dashboard render ho sake
      setLoading(false);
    }
  };
